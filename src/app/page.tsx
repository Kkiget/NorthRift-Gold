  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative h-screen flex items-center justify-center">
        <style jsx>{`
          @keyframes morph {
            0% { background-image: url('/images/blog/blog6.jpg'); }
            16.67% { background-image: url('/images/hero/preview3.jpg'); }
            33.33% { background-image: url('/images/newsletter/Produce2.jpeg'); }
            50% { background-image: url('/images/hero/preview1.jpg'); }
            66.67% { background-image: url('/images/blog/blog5.jpg'); }
            83.33% { background-image: url('/images/hero/preview2.jpg'); }
